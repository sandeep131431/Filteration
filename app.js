...
const btn = document.getElementById('Alcohol');

btn.addEventListener('click',()=>{
    const res = restaurants.filter((val)=>val.alcohol);
    document.getElementById('root').innerHTML = "";
    getrestaurant(res);
})
const btn1 = document.getElementById('Rating');
btn1.addEventListener('click',()=>{
    const res = restaurants.filter((val)=>val.rating>4.5);
    document.getElementById('root').innerHTML = "";
    getrestaurant(res);
})
